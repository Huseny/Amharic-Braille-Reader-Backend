...
class TTSModel:
    ...
    def __init__(self,
        ...
        self.uroman_dir_path = "uroman_pl/"
    ...
    def synthesize(self, txt: str, device=None):
        ...
        if is_uroman:
            if not os.path.exists(self.uroman_dir_path):
                cmd = f"git clone https://github.com/isi-nlp/uroman.git {self.uroman_dir_path}"
                print(cmd)
                subprocess.check_output(cmd, shell=True)
            uroman_pl = os.path.join(self.uroman_dir_path, "bin", "uroman.pl")
